...
\documentclass[ % the name of the author
                ...
                % the dissertation    title (which cannot be blank)
                     title={Some Structural Guidelines for CS Dissertations},
...
You can use this document as a \hologo{LaTeX}-based~\cite{book:ex1,book:ex2} 
...
use, in particular because it automatically executes \hologo{BibTeX} to 
...
for example, than including ``I used \hologo{LaTeX} to prepare my 
